            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input value="{{ old('tahun_periode', $periode->tahun_periode) }}" type="text" name="tahun_periode" id="tahun_periode" class="form-control" required>
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            if (response.status) {
                                ...
                                dataPeriode.ajax.reload(); // Reload DataTable
                            } else {
                                $('.error-text').text('');
