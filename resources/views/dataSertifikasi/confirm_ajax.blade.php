...
@else
    <form action="{{ url('/dataSertifikasi/' . $dataSertifikasi->id_input_sertifikasi . '/delete_ajax') }}" method="POST" id="form-delete">
        @csrf
        @method('DELETE')
        <div id="modal-master" class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.status) {
                                ...
                                $('#table_dataSertifikasi').DataTable().ajax.reload();
                            } else {
                                Swal.fire({
                                    icon: 'error',
