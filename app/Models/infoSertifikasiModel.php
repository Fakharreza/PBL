...
class infoSertifikasiModel extends Model
{
    ...
    protected $fillable = ['id_info_sertifikasi','id_vendor_sertifikasi','id_jenis_pelatihan_sertifikasi','id_periode','nama_sertifikasi','level_sertifikasi','tanggal_mulai','tanggal_selesai','masa_berlaku'];
